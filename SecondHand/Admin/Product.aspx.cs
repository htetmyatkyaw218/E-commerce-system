...
namespace SecondHand.Admin
{
    public partial class Product : System.Web.UI.Page
    {
        ...
        protected void btnAddOrUpdate_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@SaleOff", txtSaleOff.Text.Trim());
            cmd.Parameters.AddWithValue("@Quantity", txtQuantity.Text.Trim());
            cmd.Parameters.AddWithValue("@CategoryId", ddlCategories.SelectedValue);
            cmd.Parameters.AddWithValue("@CatName", ddlCategories.SelectedItem.Text);
        ...
        protected void rProduct_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (e.CommandName == "edit")
            {
                ...
                txtSaleOff.Text = dt.Rows[0]["SaleOff"].ToString();
                txtQuantity.Text = dt.Rows[0]["Quantity"].ToString();
                ddlCategories.SelectedValue = dt.Rows[0]["CategoryId"].ToString();
                ddlCategories.SelectedItem.Text= dt.Rows[0]["CategoryName"].ToString();
        ...
        protected void rProduct_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (Convert.ToInt32(lblQuantity.Text) <= 3)
                {
