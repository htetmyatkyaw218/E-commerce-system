<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="SecondHand.Admin.OrderStatus" %>
                                                             ...
                                                             <td><(PaymentMode) </td> -->
                                                                <td>
                                                                    <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CssClass="badge badge-primary"
                                                                        CommandArgument='<%# Eval("OrderDetailsId") %>' CommandName="Edit"><i class="ti-pencil"></i></asp:LinkButton>
                                                                </td>
                                                            </tr>
