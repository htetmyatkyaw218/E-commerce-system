<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="SecondHand.Admin.Report" %>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvFormDate" runat="server" ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"
                                        ...
                                        <div class="form-group col-md-4">
                                            <label>To Date</label>
                                            <asp:RequiredFieldValidator ID="rfvToDate" runat="server" ErrorMessage="*" ForeColor="Red" SetFocusOnError="true"
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="row pl-4">
                                        <asp:Label ID="lbTotal" runat="server" Font-Bold="true" Font-Size="Small"></asp:Label>
                                    </div>
