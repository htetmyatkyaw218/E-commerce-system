<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="SecondHand.Admin.Product" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    <label>Sale Off Price(KS)</label>
                                                    <div>
                                                        <asp:TextBox ID="txtSaleOff" runat="server" CssClass="form-control"
                                                            placeholder="Enter Sale off Price"></asp:TextBox>

                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"
                                                            ErrorMessage="Price is required" ForeColor="Red" Display="Dynamic"
                                                            SetFocusOnError="true" ControlToValidate="txtSaleOff"></asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"
                                                            ErrorMessage="Price must be in decimal" ForeColor="Red" Display="Dynamic"
                                                            SetFocusOnError="true" ControlToValidate="txtSaleOff"
                                                            ValidationExpression="^\d{0,8}(\.\d{1,4})?$"></asp:RegularExpressionValidator>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:FileUpload ID="fuProductImage" runat="server" CssClass="from-control"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <%-- <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FoodieDBConnectionString %>" ProviderName="<%$ 
                                                            ConnectionStrings:FoodieDBConnectionString.ProviderName %>" SelectCommand="SELECT [CategoryId], [Name] FROM [Categories]"></asp:SqlDataSource>--%>
                                                    </div>
                                                </div>
