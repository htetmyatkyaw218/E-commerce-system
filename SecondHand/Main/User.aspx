<%@ Page Title="" Language="C#" MasterPageFile="~/Main/Main.Master" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="SecondHand.Main.User" %>
                                                    ...
                                                    <asp:Repeater ID="rUser" runat="server" OnItemCommand="rUser_ItemCommand">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td><%# Eval("Name") %></td>
                                                                <td><%# Eval("Username") %></td> <!-- Corrected -->
                                                                <td><%# Eval("Email") %></td>
                                                                <td><%# Eval("CreateDate") %></td>
                                                                <td>
                                                                    <asp:LinkButton ID="linkDelete" runat="server" Text="Delete" CommandName="delete" CssClass="badge bg-danger"
