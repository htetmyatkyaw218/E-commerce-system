<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Customer.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="SecondHand.Customer.Profile" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title mb-4">
                                <div class="d-flex justify-container-start">
                                    <div class="image-container">
                                        ...
                                        <div class="middle pt-2">
                                            ...
                                            <a href='register.aspx?id=<% Response.Write(Session["userId"]);%>' class="btn btn-warning">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="tab-content ml-1" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade" id="connectedServices" role="tabpanel" aria-label="connectedServices-tab">
                                                        ...
                                                        <asp:Repeater ID="rOrders" runat="server">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="lblPrice" runat="server" Text='<%# string.IsNullOrEmpty(Eval("Price").ToString()) ? " " : " " + Eval("Price") +"KS" %>'></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblQuantity" runat="server" Text='<%# Eval("Quantity") %>'></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblTotalPrice" runat="server" Text='<%# Eval("TotalPrice") %>'></asp:Label> ks
                                                                    </td>
                                                                    <td>
