<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Customer.Master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="SecondHand.Customer.register" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact__form__title right-align">
                        <asp:Label ID="lblHeaderMsg" runat="server" Text="User Registration " Style="font-weight: bold; font-size: 32px; font-family: serif;"></asp:Label>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:RequiredFieldValidator ID="rfvUsername" runat="server" ErrorMessage="Username is requried" ControlToValidate="txtUsername"
                                ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                    ...
                    <div class="btn-box pt-3">
                        <div>
                            <asp:Label ID="Label1" runat="server" CssClass="pl-3 text-black-100"
                                Text="Are You Seller ? <a href='Seller.aspx' style='color: inherit;'> Register here..</a>"></asp:Label>
                        </div>
